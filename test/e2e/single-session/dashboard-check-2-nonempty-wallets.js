...
module.exports = ext.extend(module.exports, require('./add-wallet-doge-dashboard'));
...
module.exports = ext.extend(module.exports, require('./dogecoin-gen-coins'));
module.exports = ext.extend(module.exports, require("./dashboard-check-nonempty-doge-wallet"));