    ...
    browser
      ...
      .moveToElement('.btn.row.btn-signin', 2, 2, function() {
        ...
        browser
          ...
          .pause(10, function() {
            conf.responsiveTest('.flow-modal .modal-content', testName, browser, 0)
          })
          .click('.after-flow-btn')
          .waitForElementVisible('.add-new-coin-form-login-state')
          .pause(1000)
          .pause(10, function() {
            conf.responsiveTest('.flow-modal .modal-content', testName, browser, 1)
          })
